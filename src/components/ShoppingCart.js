      ...
      <div className="w-[80%] mx-auto my-12 bg-white">
        ...
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center">
             ...
             <img src={EmptyCartImage} alt="Empty Cart" className="md:w-1/2 md:h-1/2 " />
          ...
          <h2 className="text-2xl font-bold text-center text-headingColor">Shopping Cart</h2>
            ...
            <div className="border-t border-gray-300 flex flex-col md:flex-row justify-between items-center my-6 py-6">
              ...
              <div className="flex flex-col gap-2 items-center py-12 px-8 border border-primary-color rounded">
                <h4 className="text-xl font-normal text-center">Sub Total: ₦{totalAmount.toFixed(2)}</h4>
                <Link to="/check" className="text-center bg-primary-color hover:text-lightPink hover:bg-secondaryColor text-white font-bold py-2 px-4 rounded">
                  Proceed to Checkout
                </Link>
              </div>
            </div>
